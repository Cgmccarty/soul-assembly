        ...
        <div class="col-4">
            <div id="classSelect" class="pb-3">
                <div class="row no-gutters">
                    ...
                    <input id="title_input" type="text" name="title_input" placeholder="Name here..." class="input text-truncate text-dark">
                </div>
                <div class="row no-gutters">
                ...
                <div class="row no-gutters">
                    ...
                    <select id="cov_input" class="input text-truncate text-dark" name="cov_input">
                        ...
                        <option value="rosariasfingers">Rosaria's Fingers</option>
            ...
            <div id="parameters" class="mt-2 pb-2">
                ...
                <div class="row no-gutters">
                    ...
                    <input id="vgr" name="vgr" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="atn" name="atn" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="end" name="end" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="vit" name="vit" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="str" name="str" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="dex" name="dex" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="int" name="int" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="fth" name="fth" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="luck" name="luck" type="number" value="10" class="input col parameter text-dark">
                </div>
                <div class="row no-gutters">
                    ...
                    <input id="hol" name="hol" type="number" value="0" class="input col parameter text-dark">
                </div>
            </div>
